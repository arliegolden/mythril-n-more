package net.master.tutorialmod.item;

import com.github.crimsondawn45.fabricshieldlib.lib.object.FabricShieldItem;
import net.fabricmc.fabric.api.item.v1.FabricItemSettings;
import net.master.tutorialmod.TutorialMod;
import net.master.tutorialmod.item.custom.DowsingRodItem;
import net.master.tutorialmod.item.custom.ModAxeItem;
import net.master.tutorialmod.item.custom.ModHoeItem;
import net.master.tutorialmod.item.custom.ModPickaxeItem;
...
public class ModItems {
    ...
    private static Item registerItem(String name, Item item, ItemGroup group, String tooltipKey) {
        return Registry.register(Registry.ITEM, new Identifier(TutorialMod.MOD_ID, name), new Item(new FabricItemSettings().group(ModItemGroup.MYTHRIL)) {
                    @Override
